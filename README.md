...
* A backend, that interacts with the front end through an API, and that stores and retries the captions in a Postgres database, and stores and retries the images on disk (technically in an Amazon Web Services - AWS - S3 bucket)
